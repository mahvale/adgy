...
import { View, Text, StyleSheet, TouchableOpacity, FlatList, Alert, Image, Modal, TextInput } from 'react-native';
...
const addNews = async () => {
  try {
    ...
    fetchNews();
    Alert.alert('News added!', 'Your news has been added successfully.');
  } catch (error) {
  ...
  const renderNewsItem = ({ item }) => (
    <TouchableOpacity style={styles.card} onPress={()=>navigation.navigate('DetailsInfos',{
      image:item.imageUrl,
      title:item.title,
      name:item.name,
      date:item.date,
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.addButton} onPress={() => setModalVisible(true)}>
        <Text style={styles.addButtonText}>Ajouter Actualités</Text>
      </TouchableOpacity>
      ...
      >
        <View style={styles.modalView}>
          <Text style={styles.modalText}>Ajouter un nouvel article</Text>
          <TextInput
            placeholder="Titre"
            value={title}
          ...
          <TouchableOpacity style={styles.imagePicker} onPress={pickImage}>
            <Text style={styles.imagePickerText}>Choisissez une imagee</Text>
          </TouchableOpacity>
